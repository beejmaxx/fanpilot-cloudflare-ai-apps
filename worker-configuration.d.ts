/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7a0047ffd2ab6bee135cf5f8fc73c296)
// Runtime types generated with workerd@1.20260915.1 2026-09-15 nodejs_compat,web_socket_auto_reply_to_close
interface __BaseEnv_Env {
	AI: Ai;
	RALLY_ROOMS: DurableObjectNamespace<import("./src/worker/index").RallyRoom>;
	PROPOSAL_WORKFLOW: Workflow<Parameters<import("./src/worker/index").ProposalWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "RallyRoom";
	}
