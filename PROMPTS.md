...
AI-assisted coding was used throughout this repository. The human prompts are separated by product so the development history of one application is not confused with the other.
...
The app READMEs link directly to their own histories:

- [Rally documentation](apps/rally/README.md)
- [Draft documentation](apps/editor/README.md)
