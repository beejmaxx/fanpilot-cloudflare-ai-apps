/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9a8da5b288d188291185b2482160ee91)
// Runtime types generated with workerd@1.20260915.1 2026-09-15 nodejs_compat
interface __BaseEnv_Env {
	WORKSPACE_CREATION_RATE_LIMITER: RateLimit;
	AI: Ai;
	TURNSTILE_SITE_KEY: "0x4AAAAAAE5oD8yw1R52l4GL";
	TURNSTILE_EXPECTED_HOSTNAME: "launch.fanpilot.app";
	LAUNCH_WORKSPACES: DurableObjectNamespace<import("./src/worker/index").LaunchWorkspace>;
	RELEASE_ANALYSIS_WORKFLOW: Workflow<Parameters<import("./src/worker/index").ReleaseAnalysisWorkflow['run']>[0]['payload']>;
	CAMPAIGN_GENERATION_WORKFLOW: Workflow<Parameters<import("./src/worker/index").CampaignGenerationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "LaunchWorkspace";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SITE_KEY" | "TURNSTILE_EXPECTED_HOSTNAME">> {}
}
