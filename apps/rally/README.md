...
```bash
RALLY_BASE_URL=https://rally.fanpilot.app npm run test:smoke:access-remote --workspace=@fanpilot/rally
RALLY_BASE_URL=https://rally.fanpilot.app npm run test:smoke:remote --workspace=@fanpilot/rally
```
